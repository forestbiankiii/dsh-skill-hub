    ...
    ctx.skills.registerProvider(function (control) {
      ...
      return {
        ...
        get: async function (candidate) {
          const def = defs.find(function (s) { return s.name === candidate.name })
